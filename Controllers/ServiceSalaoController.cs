    ...
    public class ServiceSalaoController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var serviceSalao = await _context.ServiceSalao
                .Include(s => s.Salao)
                .FirstOrDefaultAsync(m => m.ServiceSalaoId == id);
        ...
        {
            ViewData["SalaoId"] = new SelectList(_context.Salao, "Id", "Id");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("ServiceSalaoId,SalaoId,ServiceId")] ServiceSalao serviceSalao)
        {
            ...
            ViewData["SalaoId"] = new SelectList(_context.Salao, "Id", "Id", serviceSalao.SalaoId);
            return View(serviceSalao);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ServiceSalaoId,SalaoId,ServiceId")] ServiceSalao serviceSalao)
        {
            if (id != serviceSalao.ServiceSalaoId)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!ServiceSalaoExists(serviceSalao.ServiceSalaoId))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.ServiceSalao?.Any(e => e.ServiceSalaoId == id)).GetValueOrDefault();
        }
    }
}
